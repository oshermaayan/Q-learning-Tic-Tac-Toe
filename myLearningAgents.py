...
class ValueEstimationAgent(Agent):
    ...
    def __init__(self, alpha=1.0, epsilon=0.00, gamma=0.8):
        """
...
class ReinforcementAgent(ValueEstimationAgent):
    ...
    def stopEpisode(self):
        ### Osher: This method should probably NOT be used in our case
        """
    ...
    '''
    def __init__(self, actionFn, numTraining=100, epsilon=0.5, alpha=0.5, gamma=1):
        """
...
class TicTacToeQAgent(QLearningAgent):
...
class ApproximateQAgent(TicTacToeQAgent):
    """
    ...
    def __init__(self, extractor, **args):
        #(self, extractor='IdentityExtractor', **args):
